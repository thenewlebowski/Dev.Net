...
export default function Edit(props) {
    ...
    //======Render image modification component=====//
    function handleImgMod(){
        //render ImgModOverlay
        return setimageModVisible(!imageModVisible);
        //return <ImgModOverlay visible={true} />
    }
    ...
    return (
        <Auxiliary>
            ...
            <ImgModOverlay
                imgModVisibility={handleImgMod}
                visible={imageModVisible}
            /> 
            ...
            <div className='container'>
                ...
                <div className={classes.profileHeader}>
                    <div className={classes.imgContainer}>
                        ...
                        <button onClick={handleImgMod}>Upload</button>
                        <button style={{margin: '0 10px'}}>Resize</button>
                    </div>
                    <form action='#' method='PUT' className={classes.form}>
